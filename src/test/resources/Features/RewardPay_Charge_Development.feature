@RewardPay
Feature: Development Charge Test Cases for Reward Pay

  @TC001_verifyReceiptGeneratedByACH_Card_Cheque_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: verify the receipt by tender amount via ACH,Card,Cheque
    ...
    And I wait for Sometime
    And verify the receipt details when partial payment of "Deposit_Amount" is done via ACH in Reward Pay
    And Enter the deposit Amount "Deposit_Amount2" in Quick charge
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip",Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when partial payment of "Deposit_Amount2" is done via manual card in Reward Pay
    And verify the receipt details of rest amount payment process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    Then Click on Logout

  @TC002_verifyReceiptGeneratedBycard_Card_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: verify the receipt by tender amount via manual Card and balance amount is also paid by manual card
    ...
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip",Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when partial payment of "Deposit_Amount" is done via manual card in Reward Pay
    And I wait for Sometime
  ...
  @TC003_verifyReceiptGeneratedByCard_ACH_Cheque_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: verify the receipt by deposit amount via Card,ACH,Cheque
    ...
    And Continue the partial Payment via ACH ,add "Tip" and Enter the account details "AccountType" "Account_Number" "Account_Holder" "Routing_Number" "Account_Description"
    And I wait for Sometime
    And verify the receipt details when partial payment of "Deposit_Amount2" is done via ACH in Reward Pay
    And I wait for Sometime
    And verify the receipt details of rest amount payment process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    Then Click on Logout

  @TC004_verifyReceiptGeneratedByACH_Cheque_Card_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: verify the receipt by deposit amount via ACH,Cheque,Card
    ...
    And Enter the deposit Amount "Deposit_Amount2" in Quick charge
    And I wait for Sometime
    And verify the receipt details of partial amount "Deposit_Amount2" process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip" and Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when payment of complete balance amount is done via Manual card in Reward Pay
    And I wait for Sometime
    Then Click on Logout

  @TC005_verifyReceiptGeneratedwithDiscountByACH_Cheque_Card_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC006_verifyReceiptGeneratedwithDiscountPercentageByACH_Cheque_Card_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC007_verifyInvoiceACHPayment_Rewardpay @ChargeTestCases @developmentScenarios
  Scenario: verify the invoice status after payment is done via ACH
    ...
    And verify the receipt details of payment via "Payment_Method" in Reward Pay
    And I wait for Sometime
    And Navigate to Invoices Section
    And Enter the date range "Date_From" "Date_To" to display the transaction
  ...
  @TC008_verifyInvoiceCardPayment_Rewardpay @ChargeTestCases @developmentScenarios
  ...
  @TC009_verifyInvoiceChequePayment_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC010_verifyInvoiceACHPaymentwithTip_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC011_verifyInvoiceCardPaymentwithTip_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC012_verifyInvoiceACHPaymentwithDiscountPercent_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC013_verifyInvoiceACHPaymentwithDiscountAmount_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC014_verifyInvoicecardPaymentwithDiscountPercent_Rewardpay @ChargeTestCases @developmentScenarios
  ...
  @TC015_verifyInvoiceCardPaymentwithDiscountAmount_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC016_verifyInvoiceTenderPayment_ACH_Card_Cheque_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC017_verifyInvoiceTenderPayment_Card_Cheque_ACH_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: verify the invoice status after tender payment is done via Card,Cheque and ACH
    ...
    And Click on Pay Now button from Invoice page
    And I wait for Sometime
    And Enter the deposit Amount "Deposit_Amount" in Quick charge in Reward Pay
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip",Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when partial payment of "Deposit_Amount" is done via manual card in Reward Pay
    And Enter the deposit Amount "Deposit_Amount2" in Quick charge in Reward Pay
    And I wait for Sometime
    And verify the receipt details of partial amount "Deposit_Amount2" process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    And Continue the Payment via ACH ,add "Tip" and Enter the account details "AccountType" "Account_Number" "Account_Holder" "Routing_Number" "Account_Description"
  ...
  @TC018_verifyInvoiceTenderPayment_Cheque_ACH_Card_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: verify the invoice status after tender payment is done via Cheque, ACH and card
    ...
    And I wait for Sometime
    And Enter the deposit Amount "Deposit_Amount" in Quick charge in Reward Pay
    And verify the receipt details of partial amount "Deposit_Amount" process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    And Enter the deposit Amount "Deposit_Amount2" in Quick charge in Reward Pay
    And I wait for Sometime
    And Continue the partial Payment via ACH ,add "Tip" and Enter the account details "AccountType" "Account_Number" "Account_Holder" "Routing_Number" "Account_Description"
  ...
  @TC019_verifyInvoicecardPaymentwithDiscountPercentandTip_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC071_verifypartialReceiptByACH_Card_Cheque_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: Verify user is able to process partial refund for the order paid via tender amount (ACH,card,Cheque)
    ...
    And verify cart details on cart Page
    And Click on the Charge button and Continue Partial payment
    And Enter the deposit Amount "Tender_Amount" in Quick charge in Reward Pay
    And I wait for Sometime
    And Continue the partial Payment via ACH ,add "Tip" and Enter the account details "AccountType" "Account_Number" "Account_Holder" "Routing_Number" "Account_Description"
    And I wait for Sometime
    And verify the receipt details when partial payment of "Tender_Amount" is done via ACH in Reward Pay
    And Enter the deposit Amount "Tender_Amount2" in Quick charge in Reward Pay
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip",Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when partial payment of "Tender_Amount2" is done via manual card in Reward Pay
    And verify the receipt details of rest amount payment process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
  ...
  @TC072_verifypartialReceiptByCard_Card_Rewardpay @ChargeTestCases @developmentScenarios
  Scenario: Verify user is able to process full refund after partial refund for the order paid via tender amount (card) and remaining amount with card again
    ...
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip",Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when partial payment of "Tender_Amount" is done via manual card in Reward Pay
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip" and Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when payment of complete balance amount is done via Manual card in Reward Pay
    And I wait for Sometime
  ...
  @TC073_verifyFullRefundReceiptByCard_ACH_Cheque_RewardPay @ChargeTestCases @developmentScenarios
  Scenario: Verify user is able to process full refund for the order paid via tender amount (card,ACH,cheque)
    ...
    And Continue the partial Payment via ACH ,add "Tip" and Enter the account details "AccountType" "Account_Number" "Account_Holder" "Routing_Number" "Account_Description"
    And I wait for Sometime
    And verify the receipt details when partial payment of "Tender_Amount2" is done via ACH in Reward Pay
    And I wait for Sometime
    And verify the receipt details of rest amount payment process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    And Navigate to Transaction history Section
  ...
  @TC074_verifyTipRefundReceiptByACH_Cheque_Card_RewardPay @ChargeTestCases @developmentScenarios
  ...
  @TC075_verifyTip_Partial_FullRefundReceiptByACH_Cheque_CardwithDiscountAMT_Rewardpay @ChargeTestCases @developmentScenarios
  Scenario: Verify user is able to process Tip,partial and full refund for the order paid via tender amount (ACH,cheque,card) with discount amount
    ...
    And Enter the deposit Amount "Tender_Amount2" in Quick charge in Reward Pay
    And I wait for Sometime
    And verify the receipt details of partial amount "Tender_Amount2" process via Cheque "Payment_Method2" and "Cheque_Number" in Reward Pay
    And I wait for Sometime
    And Continue the Payment via Manual card ,add "Tip" and Enter the card details "CardNumber" "CardExpMonth" "CardExpYear" "CardCVV" "CardHolderName" in Reward Pay
    And verify the receipt details when payment of complete balance amount is done via Manual card in Reward Pay
    And Navigate to Transaction history Section
  ...
  @TC076_verifyTip_Partial_FullRefundReceiptByACH_Cheque_CardwithDiscountPercent_RewardPay @ChargeTestCases @developmentScenarios
